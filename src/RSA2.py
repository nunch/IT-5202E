...
class RSA:
    ...
    def quadraticSieve(self,n,escape=None,x=None,y=None,yDecomp=None,found=False):
        print("start")
        T=2*int(math.floor(math.sqrt(n)))
        xx=0
        yy=0
        ...
        while found==False:
            ...
            if found==False:
                try:
                    ...
                    for i in range (mini,2*T+1):
                        for j in range(minj,2*T+1):
                            if i!=j:
                                try:
        ...
        if(pgcd==1):
            escape= [i,j]
            print(escape)
            return self.quadraticSieve(n, escape,x,y,yDecomp,False)
        return [pgcd,n*1.0/pgcd]
